...
public class PaymentsHistory extends HttpServlet {

    private static final String FROM = "from";
    private static final String TO = "to";
    private static final String PAYMENT_MODAL_LIST = "paymentModalList";
    private static final Logger LOGGER = Logger.getLogger(PaymentsHistory.class);


    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        LOGGER.debug("PaymentHistory starts");
        ...
        LOGGER.debug("PaymentHistory ends");
    }
